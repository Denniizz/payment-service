...
public class StripeService {
    ...
    public StripeResponse checkoutProducts(ProductRequest productRequest)
    {
        ...
        try
        {
            ...
            saveOrderToDb(productRequest, session);
        }
    ...
    public void saveOrderToDb(ProductRequest productRequest, Session session)
    {
        Order order = new Order();
        order.setProductName(productRequest.getName());
        order.setQuantity(productRequest.getQuantity());
        order.setAmount(productRequest.getAmount());
        order.setCurrency(productRequest.getCurrency() != null ? productRequest.getCurrency() : "USD");
